...
/// </summary>
public class AppQuery : DriverQuery
{
	...
	Predicate<IElement> ForPlatform(Predicate<IElement>? maui = null, Predicate<IElement>? android = null, Predicate<IElement>? ios = null, Predicate<IElement>? maccatalyst = null, Predicate<IElement>? winappsdk = null, Predicate<IElement>? tvos = null)
		=> Query.AutomationPlatform switch
		{
			Platform.Maui => maui,
			Platform.Android => android,
			Platform.Ios => ios,
			Platform.Maccatalyst => maccatalyst,
			Platform.Winappsdk => winappsdk,
			Platform.Tvos => tvos,
			_ => (e => true)
		} ?? (e => true);

	bool TryForPlatform(out string? value, string? maui = null, string? android = null, string? ios = null, string? maccatalyst = null, string? winappsdk = null, string? tvos = null)
	{
		value = Query.AutomationPlatform switch
		{
			Platform.Maui => maui,
			Platform.Android => android,
			Platform.Ios => ios,
	...
	AppQuery QueryByTypes(string[] maui = null, string[] android = null, string[] ios = null, string[] maccatalyst = null, string[] winappsdk = null, string[] tvos = null)
	{
		if (TryForPlatform(out var types, maui, android, ios, maccatalyst, winappsdk, tvos))
			Query.ByTypes(types);
	...
	public AppQuery TextField(string? marked = null)
		=> QueryByTypes(
			maui: new string[] { "", "Editor" },
			android: new string[] { "EditText" },
			ios: new string[] { "UITextField" },
			maccatalyst: new string[] { "UITextField" },
			winappsdk: new string[] { "TextBox" })
		.Marked(marked);
